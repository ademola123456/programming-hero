          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                Dynamic Digital Marketing Mastery
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Elevate your brand with tailored strategies that boost reach,
            ...
            <div className=" vstack sm:hstack justify-center gap-3 flex-sm-column items-center lg:gap-4 mb-6 sm:mb-8 lg:mb-9 max-w-650px mx-auto ">
              ...
              <button
                ...
                className="btn  btn-md lg:btn-lg bg-white text-gray-600 rounded-lg  shadow-md hover:bg-opacity-40 dark:bg-gray-700 dark:bg-opacity-50 dark:text-white"
              >
                See Our Work
              </button>
            </div>
