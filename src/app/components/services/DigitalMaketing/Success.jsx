...
const stats = [
  { value: "250%", label: "Average ROI increase for clients" },
  { value: "85%", label: "Client engagement growth rate" },
  { value: "200+", label: "Successful campaigns launched" },
        ...
        <div className="container max-w-xlg">
          <div className="section-inner panel">
            <div className="panel vstack items-center  text-center gap-4 lg:gap-6 xl:gap-8">
              ...
              >
                Our Digital Marketing Achievements
              </motion.h2>
              <p className="max-w-md">
                Delivering exceptional growth and brand visibility through
                data-driven marketing strategies that exceed client
                expectations.
              </p>
              <div
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.6, ease: "easeOut" }}
                  viewport={{ once: true }}
                  className="panel p-5 lg:py-9 rounded-2 bg-secondary dark:bg-gray-800"
                  style={{ transform: "translateY(0px)", opacity: 1 }}
                >
