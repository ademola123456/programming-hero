            ...
            <div className="panel vstack gap-4 sm:gap-6 xl:gap-8">
              ...
              >
                ...
                <p className="text-white text-sm py-3 font-semibold text-center">
                  Transform your vision into reality with a full spectrum of 3D
                  animation services, including character modeling, realistic
                  rendering, virtual reality integration, and dynamic
                  simulations, tailored for film production, game development,
