          ...
          <div className="section-inner panel">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-4 m-0">
                Cutting-Edge 3D Animation Services
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Elevate your projects with immersive 3D animations designed for
                product visualization, cinematic sequences, architectural
                renderings, <br className="d-none sm:d-block" /> and interactive
                experiences, delivering stunning visuals for film, gaming, and
                marketing.
              </p>
