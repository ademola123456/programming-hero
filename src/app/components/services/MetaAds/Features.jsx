...
const solutionsData = [
  {
    ...
    description:
      "Reach the right audience with precise demographic, interest, and behavior-based targeting.",
  ...
  },
  {
    ...
    description:
      "Craft compelling visuals and copy that capture attention and drive engagement.",
  ...
  },
  {
    ...
    description:
      "Optimize ad performance with real-time adjustments and data-driven insights.",
    image: "/paid-ads.jpg",
  },
  //   {
  //     icon: Laptop,
          ...
          <div className="section-inner panel">
            <div className="panel vstack gap-4 sm:gap-6 xl:gap-8">
              ...
              >
                ...
                >
                  Comprehensive Meta Ads
                  <span className="text-primary"> Solutions.</span>
                </h2>
                <p className="text-white text-sm py-3 font-semibold text-center">
                  Unlock the power of Meta Ads with tailored strategies that
                  enhance targeting, creativity, and performance across Facebook
                  and Instagram.
                </p>
              </motion.div>
              <div className="panel">
