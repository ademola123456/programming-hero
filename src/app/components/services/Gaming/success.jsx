...
const stats = [
  { value: "10M+", label: "Players worldwide" },
  { value: "95%", label: "Player satisfaction rate" },
  { value: "200+", label: "Games developed" },
...
export default function Success() {
  return (
    ...
    >
      <div className="section-outer panel py-6 xl:py-9 bg-white dark:bg-primary ">
        <div className="container max-w-xlg">
          <div className="section-inner panel">
            <div className="panel vstack items-center  text-center gap-4 lg:gap-6 xl:gap-8">
              ...
              >
                Our Success in Game Development
              </motion.h2>
              <p className="max-w-md">
                Crafting immersive gaming experiences that captivate players and
