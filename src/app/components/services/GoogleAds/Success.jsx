...
const stats = [
  { value: "50%", label: "Cost-per-click reduction" },
  { value: "300%", label: "Return on ad spend" },
  { value: "75+", label: "Successful campaigns" },
...
export default function Success() {
  return (
    ...
    >
      <div className="section-outer panel py-6 xl:py-9 bg-white dark:bg-gray-800 border-top">
        <div className="container max-w-xlg">
          <div className="section-inner panel">
            <div className="panel vstack items-center  text-center gap-4 lg:gap-6 xl:gap-8">
              ...
              >
                Our Google Ads Success Highlights
              </motion.h2>
              <p className="max-w-md">
                Delivering exceptional results with Google Ads that enhance
                brand exposure, optimize ad spend, and achieve significant
                conversion rates for businesses worldwide.
              </p>
              <div
