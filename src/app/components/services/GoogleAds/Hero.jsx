          ...
          <div className="section-inner panel">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-4 m-0">
                Powerful Google Ads Solutions
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Elevate your business with expertly managed Google Ads campaigns
                across Search, Display, Video, and Shopping Ads, designed to
                maximize visibility, clicks,{" "}
                <br className="d-none sm:d-block" /> and conversions with
                precision targeting and data-driven optimization.
              </p>
