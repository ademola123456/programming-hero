...
const solutionsData = [
  {
    ...
    description:
      "Drive targeted traffic with keyword-optimized Search Ads, featuring real-time bidding and A/B testing for maximum click-through rates.",
  ...
  },
  {
    ...
    description:
      "Boost brand recognition with visually appealing Display Ads across Google’s extensive network, tailored to user interests and behaviors.",
  ...
  },
  {
    ...
    description:
      "Engage audiences with compelling Video Ads on YouTube and other platforms, optimized for views, shares, and conversions.",
    image: "/paid-ads.jpg",
  },
  {
    icon: Laptop,
    title: "Shopping Ads Optimization",
    description:
      "Increase e-commerce sales with dynamic Shopping Ads, featuring product listings and competitive pricing strategies.",
          ...
          <div className="section-inner panel">
            <div className="panel vstack gap-4 sm:gap-6 xl:gap-8">
              ...
              >
                ...
                <p className="text-white text-sm py-3 font-semibold text-center">
                  Harness the full potential of Google Ads with a comprehensive
                  suite of services, including Search Ads for immediate
                  visibility, Display Ads for brand awareness, Video Ads for
                  engagement, and Shopping Ads for e-commerce success, all
                  optimized with cutting-edge tools and analytics.
                </p>
              </motion.div>
              <div className="panel">
                <div
