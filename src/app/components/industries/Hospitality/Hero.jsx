          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                Your Hospitality Website Design Partner - Webflow Development
                for Hotels & BnBs
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Enhance your hotel's online presence with Webyansh's expert
                Webflow development. We create custom, responsive websites
                designed to increase direct bookings and provide a seamless
