...
const solutionsData = [
  {
    ...
    description:
      "We shape intuitive, conversion-focused designs using bold blocks, white space, and interactive elements to captivate shoppers.",
  ...
  },
  {
    ...
    description:
      "Harness Webflow’s no-code CMS and headless commerce for lightning-fast stores that scale with your business.",
    image: "/graphics.jpg",
  },
  {
    icon: TrendingUp,
    title: "Ecommerce SEO & AEO",
    description:
      "Optimize for search intent, voice queries, and AI answer engines to capture high-intent buyers on Google, Bing, and chatbots",
  ...
  },
  {
    ...
    description:
      "Custom Shopify themes and integrations deliver seamless checkout experiences that boost AOV and loyalty",
  ...
  },
  {
    ...
    description:
      "Streamline your move from legacy platforms like WordPress and Magento to Webflow without losing SEO equity .",
    image: "/ai-mechanics.jpg",
  },
  {
    icon: Rocket,
    title: "Ongoing Webflow/Shopify Maintenance",
    description:
      "24/7 Instant webflow/shopify maintenance and support for eCommerce businesses. You take of your growth and we take care of your site.",
        ...
        <div className="container  max-w-full">
          <div className="section-inner panel">
            <div className="panel vstack gap-4 sm:gap-6 xl:gap-8">
              ...
              >
                Comprehensive <span className="text-primary">Ecommerce</span>{" "}
                Solutions to Elevate Your Online Store
              </h2>
              <h5 className=" h5 lg:h5 xl:h4 m-0 text-center max-w-550px mx-auto">
                From stunning Ecommerce UI/UX design to seamless Webflow
                development and powerful SEO strategies, we deliver end-to-end
                ecommerce solutions.
              </h5>
              <div className="panel">
                <div
