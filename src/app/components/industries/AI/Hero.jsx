          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                Designing Tomorrow's AI Stories Today with Webflow
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Every AI innovation has a story—what’s yours? Let’s create a
                website that brings your vision to life and captivates your
                audience in this exciting landscape.
              </p>
            </div>
